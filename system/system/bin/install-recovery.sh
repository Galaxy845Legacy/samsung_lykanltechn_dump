#!/system/bin/sh
if ! applypatch --check EMMC:/dev/block/bootdevice/by-name/recovery:28082704:bd07194063dd341afc0cefe940dec03db7fa8ef5; then
  applypatch \
          --patch /system/recovery-from-boot.p \
          --source EMMC:/dev/block/bootdevice/by-name/boot:20156944:73b95e8c5df9cc7cb08dbd259e9b840be340d1fd \
          --target EMMC:/dev/block/bootdevice/by-name/recovery:28082704:bd07194063dd341afc0cefe940dec03db7fa8ef5 && \
